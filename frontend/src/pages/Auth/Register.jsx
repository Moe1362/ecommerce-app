...
const Register = () => {
  ...
  return (
    <section className="pl-[10rem] flex flex-wrap">
        ...
        <form onSubmit={submitHandler} className="container w-[25rem]">
          <div className="my-[2rem]">
            ...
            <input
              type="text"
              id="name"
              className="m-1 p-2 border rounded w-full"
      ...
      <img src="https://www.opinion-internationale.com/wp-content/uploads/2014/09/1.jpg" alt="" className="h-[45rem] w-[59%] xl:block md:hidden sm:hidden rounded-lg" />
    </section>
  );
};
